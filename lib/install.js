...
Installer.prototype.loadAllDepsIntoIdealTree = function (cb) {
  ...
  if (installNewModules) {
    ...
    if (this.prod) {
      steps.push(
        [prefetchDeps, this.idealTree, this.idealTree.package.dependencies || {}, cg.newGroup('prefetchDeps')],
        [loadDeps, this.idealTree, cg.newGroup('loadDeps')])
    }
    if (this.dev) {
      steps.push(
        [prefetchDeps, this.idealTree, this.idealTree.package.devDependencies || {}, cg.newGroup('prefetchDeps')],
